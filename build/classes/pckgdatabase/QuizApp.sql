CREATE DATABASE  IF NOT EXISTS `oes` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `oes`;
...
INSERT INTO `admin` VALUES ('admin','admin','what is your name','ashmeet',1),('ashmeet4293','admin','1','Java',2),('ashmeet42','admin','1','java',3),('admin123','admin','1','java',4),('ramt','ramt','What is your favorite food ?','Pizsa',5);
...
INSERT INTO `students` VALUES ('Ashmeet Tiwary',12,'ashmeet4293@gmail.com','Male','1111-01-01','ashmeet4293','admin','Pokhara','2017-11-06 05:07:22','Which is your favorite book?','java',10,'Excellent','Pokhara','C'),('Kundan Chaudhary',13,'kundan@gmail.com','Male','2222-01-12','kundanc','student','student','2017-11-08 05:34:17','Which is your favorite book?','Java',6,'Good','Pokhara','C');
...
-- Dump completed on 2017-11-09  9:03:11
